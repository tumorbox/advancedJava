...
public class HashSetTest2 {
	public static void main(String[] args) {
		...
		//합집합을 구현하는 방법 => Set객체를 생성할 때 합집으로 표현할 Set을 생성자의 매개변수로 전달
		...
		//set과 set3의 교집합구하기
		set.retainAll(set3);			//set과 set3에 저장된 요소 중 중복되는 요소만 갖고 새로운 set구조가 만들어진다.
		print(set,"교집합set");			//set과 set3을 비교해서 일치하는 것만 남기고 나머지가 제거된다.
	}	
